...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <div className="group flex w-[280px] shrink-0 snap-start flex-col gap-4 sm:w-[320px]">
      ...
      <div className="flex flex-col gap-3">
        ...
        <div className="flex flex-wrap gap-2" role="group" aria-label={`Tamanhos disponíveis para ${product.name}`}>
