  ...
  return (
    <section className="flex flex-col gap-6" aria-labelledby="ident-heading">
      ...
      <div className="flex flex-col gap-4">
        ...
        />
        <CheckoutField label="Nome Completo" id="nome" autoComplete="name" placeholder="Como no documento" />
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <CheckoutField label="CPF" id="cpf" inputMode="numeric" placeholder="000.000.000-00" />
          <CheckoutField
            label="Telefone"
            id="telefone"
            type="tel"
      ...
      <div className="flex flex-col gap-4 border-t border-border pt-6">
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          ...
          <CheckoutField label="Endereço" id="rua" className="sm:col-span-2" placeholder="Rua, avenida..." />
        </div>
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
          <CheckoutField label="Número" id="numero" inputMode="numeric" placeholder="123" />
          <CheckoutField label="Complemento" id="complemento" placeholder="Apto, bloco" />
          <CheckoutField label="Bairro" id="bairro" className="col-span-2 sm:col-span-2" placeholder="Seu bairro" />
        </div>
        <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
          <CheckoutField label="Cidade" id="cidade" className="sm:col-span-2" placeholder="Sua cidade" />
          <CheckoutField label="UF" id="uf" placeholder="SP" />
        </div>
        {cepLoaded && (
